<template>
  ...
  <div class="card mb-10">
    ...
    <div class="card-header card-header-stretch">
      <ul class="nav nav-stretch nav-line-tabs fw-semobold border-0" role="tablist" id="kt_layout_builder_tabs"
                  ...
                  <div class="row" data-kt-buttons="true" data-kt-buttons-target=".form-check-image,.form-check-input"
                      ...
                      <label class="form-check-image form-check-success" :class="[themeMode === 'light' && 'active']">
                        ...
                        <div class="form-check form-check-custom form-check-solid form-check-sm form-check-success">
                          <input class="form-check-input" type="radio"
                            :checked="themeMode === 'light' ? undefined : false" value="light" name="theme_mode"
                    ...
                    <div class="col-6">
                      ...
                      <label class="form-check-image form-check-success" :class="[themeMode === 'dark' && 'active']">
                        ...
                        <!--begin::Check-->
                        <div class="form-check form-check-custom form-check-solid form-check-sm form-check-success">
                          <input class="form-check-input" type="radio" :checked="themeMode === 'dark' ? undefined : false"
                            value="dark" name="theme_mode" @change="onThemeModeChange" />
                          <!--begin::Label-->
