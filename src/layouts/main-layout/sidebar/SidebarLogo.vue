  ...
  <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
    ...
    <router-link to="/">
      <img v-if="layout === 'dark-sidebar' ||
        ...
        " alt="Logo" :src="getAssetPath('media/logos/default-dark.svg')" class="h-25px app-sidebar-logo-default" />
      <img v-if="themeMode === 'light' && layout === 'light-sidebar'" alt="Logo"
        :src="getAssetPath('media/logos/default.svg')" class="h-25px app-sidebar-logo-default" />
